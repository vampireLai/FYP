...
import '../Babysitter/edit_babysitter_profile.dart';
import 'package:kiddie_care_app/services/ml_service.dart';

class SignUpBabysitter extends StatefulWidget {
  final String role;
  
  const SignUpBabysitter({super.key, required this.role});

  @override
  State<SignUpBabysitter> createState() => _SignUpBabysitterState();
}

class _SignUpBabysitterState extends State<SignUpBabysitter> {
  @override
        ...
        child: Column(
          children: <Widget>[
            Stack(
              ...
              children: <Widget>[
                Image.asset('images/signupbabysitter.jpg'),
                const Padding(
