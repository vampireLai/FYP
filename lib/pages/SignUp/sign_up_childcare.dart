...
import '../ChildcareCentre/edit_childcare_profile.dart';
import 'package:kiddie_care_app/services/ml_service.dart';
import 'package:kiddie_care_app/locator.dart';

class SignUpChildcare extends StatefulWidget {
  final String role;

  const SignUpChildcare({super.key, required this.role});

  @override
  State<SignUpChildcare> createState() => _SignUpChildcareState();
}

class _SignUpChildcareState extends State<SignUpChildcare> {
  @override
